"""
Example: How to call the poshmark-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/poshmark-scraper
...
def run_actor():
    """Run the poshmark-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/poshmark-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://poshmark.com/search?query=hats&type=listings&src=dir"}],
            "maxItems": 20,
